...
function PlayerDetailModal({ player, origin, onClose, onBuy, onSell, onSign, canBuy }: { player: Player | AcademyProspect | null; origin: PlayerOrigin; onClose: () => void; onBuy?: () => void; onSell?: () => void; onSign?: () => void; canBuy?: boolean }) {
