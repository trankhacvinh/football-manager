...
import { Trophy, Users, CalendarDays, Dumbbell, RotateCcw, Play, WalletCards, ShoppingCart, RefreshCw, X, Eye, ChevronsRight, Search, Moon } from 'lucide-react';
...
const ensureState = (state: GameState): GameState => ({ ...state, day: state.day ?? 1, actionsRemaining: state.actionsRemaining ?? 3, maxActionsPerDay: state.maxActionsPerDay ?? 3, academyProspects: state.academyProspects ?? [] });
